...
// Reads the utility classes back out of the stylesheet the page already loaded,
// so the documentation cannot drift from the CSS the way cozy-ui's generated
// class list did.
