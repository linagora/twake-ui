...
/**
 * One rule runs through this page: monospace means you can type it into your
 * code. Class names, variable names and declarations are set in it; everything
 * else is prose. `tone` only distinguishes what the package ships from what
 * twake-mui provides at runtime.
 */
...
/** A hairline and a quiet heading separate sections — no card chrome. */
...
/** Every identifier starts at the same x, top to bottom. That is the rail. */
...
/**
 * One menu for the whole page. The groups are separated by a rule rather than
 * labelled, because a label would repeat what the destinations already say —
 * and it is what tells the Spacing chapter from the Spacing class family.
 */
